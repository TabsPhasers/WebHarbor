...
def main():
    ...
    j.check("db_others_kept", all(k in sa for k in KEEP),
            f"the chair (2) and studio (21) must remain saved; after={sa}")
    j.emit()
